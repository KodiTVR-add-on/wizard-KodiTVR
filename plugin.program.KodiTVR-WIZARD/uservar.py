...
ADDONTITLE     = 'KodiTVR-WIZARD'
EXCLUDES       = [ADDON_ID]
# Text File with build info in it.
BUILDFILE      = 'https://pastebin.com/raw/wPzsuK9q'
...
ICONBUILDS     = 'https://i.imgur.com/3spstUk.png'
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']KodiTVR-WIZARD[/COLOR])[/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR][/I]'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Gracias por elegir KodiTVR-WIZARD.'
#Images used for the contact window.  http:// for default icon and fanart
CONTACTICON    = 'https://i.imgur.com/3spstUk.png'
...
WIZARDFILE     = 'https://pastebin.com/raw/wPzsuK9q'
#########################################################
